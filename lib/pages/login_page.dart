  ...
  Future<void> _checkBiometricAvailability() async {
    try {
      ...
      if (canUse) {
        ...
        print('✅ [LoginPage] Biometría disponible');
      } else {
        if (mounted) {
  ...
  void _login() async {
    ...
    try {
      ...
      if (exito) {
        ...
        // Activa login con huella para el próximo inicio de sesión. Antes
        // nada llamaba a esto en ningún flujo — la huella nunca se
        // habilitaba, así que el botón de biometría en esta pantalla
        // siempre fallaba ("usuario no encontrado") sin importar el
        // dispositivo.
        if (_canUseBiometrics) {
          await BiometricService.instance.enableBiometricLogin(usuario);
        }
          ...
          child: Column(
            ...
            children: [
              ...
              if (_canUseBiometrics) ...[
                ...
                // Botón de Biometric Login: solo el ícono, sin texto ni badge.
                Center(
